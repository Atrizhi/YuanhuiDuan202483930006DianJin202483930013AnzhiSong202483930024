...
public class GameData implements Serializable {
	...
	int pX, pY, heroHealth, keyNum, blessNum;
	int[][][] map;
	...
	void printMap() {
		...
		System.out.print(
				"Health:" + Integer.toString(heroHealth) + "  KeyNum:" + Integer.toString(keyNum) + " Bless: " + Integer.toString(blessNum) + "  Menu:press 0\n");
	}
